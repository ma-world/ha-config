...
def all_app_configs_warning() -> str:
    if include_all_app_configs_enabled():
        return ("<p class='warning'><strong>All app configurations are included.</strong> "
                "The backup contains configuration data for other apps. Keep the destination repository private and review the active Git ignore rules.</p>")
    return ""
...
class Handler(BaseHTTPRequestHandler):
    def do_GET(self):
        ...
        page = (PAGE.replace("{notice}", message + rules_error)
                     ...
                     .replace("{all_app_configs_warning}", all_app_configs_warning())
